...
it('gets initialized with allowed domain and email lists', function () {
    Config::set('mail-middleware.sending.middleware.allowed.domains', $allowedDomains = ['foo.de', 'bar.de']);
    Config::set('mail-middleware.sending.middleware.allowed.emails', $allowedEmails = ['bar@foo.de', 'foo@bar.de']);
...
it('checks if the recipient has an allowed domain', function () {
    Config::set('mail-middleware.sending.middleware.allowed.domains', ['bar.de']);
...
it('checks if the recipient has an allowed email', function () {
    Config::set('mail-middleware.sending.middleware.allowed.emails', ['foo@bar.de']);
