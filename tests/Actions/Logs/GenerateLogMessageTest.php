...
it('generates a log message', function (bool $hasClassName, bool $canceled) {
    Config::set('mail-middleware.sending.log.include.middleware', false);
    Config::set('mail-middleware.sending.log.include.headers', false);
    Config::set('mail-middleware.sending.log.include.message_data', false);
    Config::set('mail-middleware.sending.log.include.body', false);

    $expectation = 'LaravelMailMiddleware.MessageSending:';
...
it('generates a log message with middleware', function () {
    Config::set('mail-middleware.sending.log.include.middleware', true);
    Config::set('mail-middleware.sending.log.include.headers', false);
    Config::set('mail-middleware.sending.log.include.message_data', false);
    Config::set('mail-middleware.sending.log.include.body', false);
    ...
    LaravelMailMiddleware.MessageSending:
...
it('generates a log message with headers', function () {
    Config::set('mail-middleware.sending.log.include.middleware', false);
    Config::set('mail-middleware.sending.log.include.headers', true);
    Config::set('mail-middleware.sending.log.include.message_data', false);
    Config::set('mail-middleware.sending.log.include.body', false);
...
it('generates a log message with body', function () {
    ...
    Config::set('mail-middleware.sending.log.include.headers', false);
    Config::set('mail-middleware.sending.log.include.message_data', false);
    Config::set('mail-middleware.sending.log.include.body', true);
...
it('generates a log message with message data', function () {
    Config::set('mail-middleware.sending.log.include.middleware', false);
    Config::set('mail-middleware.sending.log.include.headers', false);
    Config::set('mail-middleware.sending.log.include.message_data', true);
    Config::set('mail-middleware.sending.log.include.body', false);
